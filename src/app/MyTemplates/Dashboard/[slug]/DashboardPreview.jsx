...
export const DashboardPreview = ({components, onSelectItem, viewport, idUniqueIdentifier}) => {
        ...
        const addSelectComponent = (obj) => {
            ...
            return newObj.map((component, index) => {
                if (component !== undefined) {
                    let className = `${component["settings" + viewport.type]?.className} ${(idUniqueIdentifier === component?.idUniqueIdentifier ? " outline select-none outline-offset-2 outline-cyan-400 z-40" : "")}`
    ...
    return (
        <div className="relative min-h-[700px] h-auto w-auto">
