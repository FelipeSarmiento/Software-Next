    ...
    return (
        <>
            <div className="min-h-[calc(100vh_-_84px)] px-4">
                ...
                <div className="grid grid-cols-1 max-w-screen 2xl:grid-cols-2 mx-auto box-border gap-8">
                    {
                        templates.length > 0 ? templates.map((template, index) => (
                            <div key={ template.idtemplate * index } className="grid grid-cols-1 lg:grid-cols-2 p-2  md:p-6 md:max-w-[750px] lg:h-72 lg:max-h-72 rounded-lg border-2 border-neutral-300">
