...
export const Template = ({ components, viewport, path }) => {
                    ...
                    switch (component.group) {
                        ...
                        case "container":
                            switch (component.type) {
                                ...
                                case "link":
                                    return (
                                        <a key={component.idUniqueIdentifier} href={ component.href.split("|")[0] === 'internal' ? window.location.host + "/" + window.location.pathname.split("/")[1] + component.href.split("|")[1] : component.href.split("|")[1] } target={ component.target } className={className}>
                                            {component.items?.length > 0 ? addSelectComponent(component.items) : ""}
                                        </a>
                                    )
                                case "main":
