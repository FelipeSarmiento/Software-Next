    ...
    return (
        <div
            ...
            <p className="text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300">
                Login to start designing your portfolio
            </p>
            <form className="my-8" onSubmit={ (e) => {
                ...
                <div className="flex flex-col space-y-4">
                    <button onClick={() => signIn()}
                        ...
                        <Link href='/Auth/Register' className="relative group/btn flex space-x-2 items-center justify-start px-4 w-full text-black rounded-md h-10 font-medium shadow-input bg-gray-50 dark:bg-zinc-900 dark:shadow-[0px_0px_1px_1px_var(--neutral-800)]">
