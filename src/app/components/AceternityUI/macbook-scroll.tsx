...
export const MacbookScroll = ({
    ...
    return (
        <div
            ref={ref}
            className="min-h-[250vh]  flex flex-col items-center py-0 md:py-40 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
        >
            <motion.h2
                style={{
                ...
                className="text-white text-5xl font-bold mb-20 text-center"
            >
                {title || (
                    <span>
...
const AceternityLogo = () => {
    return (
        <div className="skey-x-[100deg] font-extrabold">
            MyPortfolio
        </div>
    );
};
