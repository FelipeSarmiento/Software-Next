                            ...
                            <h3 className="relative flow-root">
                                <div onClick={(event) => {
                                    selectItem(event, section)
                                     ...
                                     className={`relative focus:border-stone-800 border-2 rounded-md mt-1 h-10 xl:h-8 2xl:h-10 z-50 flex w-full items-center justify-between text-sm xl:text-[10px] 2xl:text-sm  px-1 bg-black ${(optionSelected?.idUniqueIdentifier === section?.idUniqueIdentifier ? "border-cyan-400 " : "border-stone-800 ")}`}>
                                    <div
                                        ...
                                        <span title={section?.nameHTML ? section?.nameHTML : section.label}
                                              className="pl-1 w-[80%] truncate">{section?.nameHTML ? section?.nameHTML : section.label}</span>
                                        {
                            ...
                            <Disclosure.Panel className="relative h-full">
                                {
                                    section.items?.length > 0 ? (
                                        <div className="h-full left-2 py-1 w-1 absolute">
                                            <div
                                                className="border-cyan-400 h-full w-full border-2 bg-cyan-400 rounded-md"/>
                                        </div>
                                    ) : ''
                                }
                                        ...
                                        <>
                                            {option.group === "container" ? (
                                                ...
                                                <div key={option.idUniqueIdentifier} id={option.idUniqueIdentifier}
                                                    ...
                                                    <Disclosure as="div"
                                                                className="w-full flex items-center relative pl-3">
                                                        <h3
                                                            onClick={(event) => {
