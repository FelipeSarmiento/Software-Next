    ...
    return (
        <>
            <div className="min-h-[calc(100vh_-_84px)] px-4">
                <header className="h-32 px-12 mb-5 shadow">
                    <div className="mx-auto h-full flex items-center justify-between">
                        <h1 className="flex items-center justify-around text-4xl font-bold tracking-tight text-white">
                            My Projects
                        </h1>
                        <button
                            className="px-6 border-2 border-white flex items-center space-x-2 font-bold text-white h-12 rounded-md hover:text-cyan-500 hover:border-cyan-500"
                            onClick={open}>
                ...
                <div className="grid grid-cols-2 w-max mx-auto gap-5">
                {
                    projects.length > 0 ? projects.map((project, index) => (
                            <div key={ project.idproject * index } className="w-full grid grid-cols-2 p-6 md:w-[40vw] h-80 rounded-lg border-2 border-neutral-300">
    ...
    return (
        <div className="fixed top-0 left-0 w-full flex items-center justify-center h-screen bg-stone-950/90">
            <div className="relative p-6 w-2/4 bg-black border-2 border-white text-white rounded-lg">
                ...
                <div>
                    <form onSubmit={ handleProjectForm } className="grid grid-cols-2 gap-x-8">
                        <div>
                            <div className="mt-4">
